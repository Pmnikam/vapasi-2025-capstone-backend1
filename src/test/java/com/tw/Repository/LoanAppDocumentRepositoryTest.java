...
@DisplayName("Tests for LoanAppDocumentRepository")
public class LoanAppDocumentRepositoryTest {
    ...
    @Test
    @Order(2)
    @DisplayName("Find Loan Document by ID")
